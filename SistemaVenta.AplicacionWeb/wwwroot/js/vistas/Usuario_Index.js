...
$(document).ready(function () {
    ...
    tablaData = $('#tbdata').DataTable({
        ...
        "columns": [
            { "data": "idUsuario", "visible": false, "searchable": false }, // Corrección de "flase" a "false"
            {
                "data": "urlFoto", render: function (data) {
                    return `<img style="height:60px" src="${data}" class="rounded mx-auto d-block" />`; // Se agregaron comillas alrededor de ${data}
                }
            },
            { "data": "nombre" },
            { "data": "correo" },
...
function mostrarModal(modelo = MODELO_BASE) {
    ...
    $("#txtRol").val(modelo.idRol == 0 ? $("#cboRol option:first").val() : modelo.idRol)
